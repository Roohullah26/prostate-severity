...
input_source = st.sidebar.radio("Input Source", ["Upload Images", "Demo Mode", "Synthetic Data"])
...
---
**How to use:**
1. Select input source (Demo, Synthetic, or Upload)
...
- Python 3.8+
- Streamlit, NumPy, PIL
- FastAPI server running for image uploads
